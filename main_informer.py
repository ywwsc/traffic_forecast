...
node_num = 1683  # PEMS04:307, 03:358, 07:883, 08:170   wenzhou：1683
...
parser.add_argument('--node_num', type=int,  default=1683, help='num of nodes')
...
# node_num = 170 # PEMS:307,wenzhou：1683
# dataset = 'PEMS08'
# parser = argparse.ArgumentParser(description='[Informer] Long Sequences Forecasting')
# parser.add_argument('--model', type=str,  default='informer',help='model of experiment, options: [informer, informerstack, informerlight(TBD), autoformer]')
# parser.add_argument('--node_num', type=int,  default=node_num, help='num of nodes')
# parser.add_argument('--data', type=str,  default=dataset, help='data')
# parser.add_argument('--root_path', type=str, default='./data/', help='root path of the data file')
# parser.add_argument('--data_path', type=str, default=dataset+'.npz', help='data file')
# parser.add_argument('--graph_data_path', type=str, default=dataset+'.csv', help='graph data file')
...
parser.add_argument('--attn', type=str, default='full', help='attention used in encoder, options:[prob, full, AutoCor]')
...
parser.add_argument('--poi', type=bool, default=False, help='whether to use poi data in embedding')
...
data_parser = {
    ...
    'wenzhou_60m': {'data': args.data_path, 'T': '_','M': [1, 1, 1], 'S': [1, 1, 1], 'MS': [node_num, node_num, 1]},
    'wenzhou_15m': {'data': args.data_path, 'T': '_','M': [1, 1, 1], 'S': [1, 1, 1], 'MS': [node_num, node_num, 1]},
    'wenzhou_5m': {'data': args.data_path, 'T': '_','M': [1, 1, 1], 'S': [1, 1, 1], 'MS': [node_num, node_num, 1]},
    'PEMS04': {'data': args.data_path, 'T': '_','M': [1, 1, 1], 'S': [1, 1, 1], 'MS': [1, 1, 1]},
    'PEMS03': {'data': args.data_path, 'T': '_','M': [1, 1, 1], 'S': [1, 1, 1], 'MS': [1, 1, 1]},
    'PEMS07': {'data': args.data_path, 'T': '_','M': [1, 1, 1], 'S': [1, 1, 1], 'MS': [1, 1, 1]},
    'PEMS08': {'data': args.data_path, 'T': '_','M': [1, 1, 1], 'S': [1, 1, 1], 'MS': [1, 1, 1]},
