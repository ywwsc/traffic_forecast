...
parser.add_argument('--node_num', type=int,  default=307, help='num of nodes')
...
parser.add_argument('--label_len', type=int, default=36, help='start token length of Informer decoder')
...
data_parser = {
    ...
    'wenzhou_60m': {'data': args.data_path, 'T': '_','M': [node_num, node_num, node_num], 'S': [1, 1, 1], 'MS': [node_num, node_num, 1]},
