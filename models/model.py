...
class Autoformer(nn.Module):
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, edge_index, weights,
                enc_self_mask=None, dec_self_mask=None, dec_enc_mask=None):
        # decomp init
        ...
        enc_out, attns = self.encoder(enc_out, attn_mask=enc_self_mask)
        # dec
        dec_out = self.dec_embedding(seasonal_init, x_mark_dec, edge_index, weights)
